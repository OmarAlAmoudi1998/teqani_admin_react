...
const TicketReportBugs = () => {
    const dbDirectory = "contactUs/Report Bugs/quaries"
    ...
    const [selectedValue, setSelectedValue] = useState('notreplied');
    ...
    return (
        ...
        <div className="HomeDesign">
            ...
            <div className="dBar">
                ...
                <h1 className="detailsHead">Report bugs</h1>
...
export default TicketReportBugs;